...
export async function generateMenuPdf(
  ...
  const logoImg = await new Promise<HTMLImageElement | null>((resolve) => {
    ...
    img.src = `${import.meta.env.BASE_URL}gigliola-wide.png`;
  });
...
export async function generateReceiptPdfBlob(order: any, paymentAmount: number, paymentMethod: string, paymentDescription: string = "", logoUrl: string = `${import.meta.env.BASE_URL}gigliola-wide.png`) {
