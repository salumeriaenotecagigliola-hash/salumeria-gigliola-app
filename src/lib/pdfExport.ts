...
export async function generateReceiptPdfBlob(order: any, paymentAmount: number, paymentMethod: string, paymentDescription: string = "", logoUrl: string = `${import.meta.env.BASE_URL}logo.png`) {
